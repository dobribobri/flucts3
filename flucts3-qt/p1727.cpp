...
void p1727::tco_calibrate() {
//TBD
    std::cout << "Внешн. калибровка..." << std::endl;
    std::cout << "OK" << std::endl;
    return;
}

void p1727::sfu_compute() {
...
void p1727::sfu_compute(std::string _fname) {
//TBD
...
p1727::~p1727() {
    //std::cout << "Деструктор.. p1727 ..OK" << std::endl;
}
